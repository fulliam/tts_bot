...
class TTS:
    ...
    default_init = {
        ...
        "model_path": "v3_1_ru.pt",  # путь к файлу TTS модели Silero
    ...
    def __init__(
        ...
        self.ffmpeg_path = ffmpeg_path if ffmpeg_path else TTS.default_init["/usr/bin/ffmpeg"]
    ...
    def wav_to_ogg(
        ...
        proc = subprocess.Popen(["ffmpeg", "-i", in_filename, out_filename], 
